    ...
    <nav class="custom-navbar">
        ...
        <div class="right">
            <div class="search-bar__container">
                ...
                <span class="decorative-pipe search-bar__decorative-pipe"></span>

                <button type="button" class="button__command">
            ...
            <button type="button" class="button__profile">
                <img src="../assets/profile-avatar.png" alt="" size="32" width="32" height="32">
            </button>
        </div>
    </nav>
</template>
